...
public class Extreme_Algorithms
{
    ...
    internal int Chosen_maxdim { get; set; } = 110;
    ...
    {
        int untouched = 0;
        foreach(Package2D p in Load_order.ToList().Reverse)
        {   if(untouched > Load_order.Count/5) { break; }
